...
Due Date: 06-02-25
Course: C0P3275C
Assignment: Assignment 3 FUNCTIONS
Professor: Sorgente

Description: (Your program description goes here -- what it does--In the program we
processed....
*************************************************************/
...
void LeapYear(const string &name,const int &year);

int main()
{
    //declare variables for 3 first names, ages, and birthyear
    string name1, name2, name3;
    int age1, age2, age3, birth_year1,birth_year2,birth_year3;
    ...
    do{
        ...
        cout << std::endl;
        GetGeneration(name2, birth_year1);
        cout << std::endl;
        GetGeneration(name3, birth_year1);
        cout << std::endl;
...
{
    //Collects the user information while using a if statement 
        cout << "Enter Name: ";
        cin >>  name;
